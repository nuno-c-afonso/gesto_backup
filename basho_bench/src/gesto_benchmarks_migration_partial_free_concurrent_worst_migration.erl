-module(gesto_benchmarks_migration_partial_free_concurrent_worst_migration).
...
get_closest_replicas_from_file(Device, DictRes) ->
    case file:read_line(Device) of
        ...
        {ok, Line} ->
            ...
            %% Debugging
            % lager:info("O/D: ~p/~p", [IdOrigin, IdDestination]),
...
read_bkey(BKey={Bucket, _}, S0=#state{node=Node,
                          clock=Clock0,
                          mydc=MyDc,
