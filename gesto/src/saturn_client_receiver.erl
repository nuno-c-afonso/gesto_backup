...
%% ALL MIGRATIONS %%
%%%%%%%%%%%%%%%%%%%%
%% End the migration on the new replica
handle_call({migration, MyId, LocalLabel, RemoteLabel}, From, S0) ->
    saturn_leaf_converger:migrate(MyId, LocalLabel, RemoteLabel, From),
    {noreply, S0}.

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% MIGRATION WITH PARTIAL REPLICATION %%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Create the label and acknowledge the client
handle_cast({migration_partial, MyId, Id}, S0) ->
    saturn_leaf_producer:migrate(MyId, Id),
    {noreply, S0};
