...
insert(ETS, BKey, Timestamp, PrefListOrigin, OriginKey) ->
    true =  ets:insert(ETS, {BKey, {Timestamp, PrefListOrigin, OriginKey}}),
    ETS.
...
remove(ETS, BKey, Timestamp, PrefListOrigin, OriginKey) ->
    ets:delete_object(ETS, {BKey, {Timestamp, PrefListOrigin, OriginKey}}),
    ETS.
